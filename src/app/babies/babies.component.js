...
var BabiesComponent = /** @class */ (function () {
    ...
    BabiesComponent.prototype.edit = function (slot) {
        this.router.navigate(['babies', slot.id]);
        return false;
    };
    BabiesComponent.prototype.delete = function (slot) {
        var _this = this;
        this.api.babyProfileApi.delete(slot.id).then(function () {
            _this.babies = _this.babies.filter(function (x) { return x !== slot; });
        });
        return false;
    };
    BabiesComponent.prototype.displayGender = function (gender) {
